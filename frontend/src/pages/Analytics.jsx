...
=======
                        dayInfo.isStudyDay ? 'bg-blue-50 dark:bg-blue-900/20' : ''
>>>>>>> upstream/main
                      }`}
                    >
                      {dayInfo.day && (
...
=======
                          dayInfo.isStudyDay ? 'text-blue-800 dark:text-blue-200 font-bold' : 'text-main'
>>>>>>> upstream/main
                        }`}>
                          {dayInfo.day}
                        </span>
...
=======
                  <div key={course.courseId} className="bg-canvas-alt rounded-lg p-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-green-600 dark:text-green-400 text-sm font-medium">{progressPercent}</span>
                    </div>
                    <div className="w-full bg-border rounded-full h-2 mb-3">
                      <div className="bg-green-600 dark:bg-green-500 h-2 rounded-full" style={{ width: progressPercent }}></div>
                    </div>
                    <div className="space-y-1 text-sm">
                      <div className="text-muted">Progress: {progress} lessons</div>
>>>>>>> upstream/main
